...
public class GUIDemo {
    ...
    private JTabbedPane initTabbedPane() {
        ...
        browserVersion = new ArrayList<>(6);
        browserVersion.add(DriverManagerType.CHROME.name());
        browserVersion.add(DriverManagerType.FIREFOX.name());
        browserVersion.add(DriverManagerType.IEXPLORER.name());
        browserVersion.add(DriverManagerType.OPERA.name());
        browserVersion.add(DriverManagerType.EDGE.name());
    ...
    public void addEvents() {
        ...
        runButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                caseEntity.setSaveDirecotry(new File(caseEntity.getSaveDirecotry()).getAbsolutePath());
                saveFile(caseEntity);
